...
const ldClient = LaunchDarkly.initialize('62793d816f126a151a9149f0', user);
...
ldClient.waitForInitialization().then(function() {
  ...
  const flagValue = ldClient.variation("boss-up-feature", false);

  showMessage("Feature flag " + "boss-up-feature" + " is " + flagValue + " for this user");
